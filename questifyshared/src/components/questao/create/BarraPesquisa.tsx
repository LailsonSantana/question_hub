...
const BarraPesquisa: React.FC<BarraPesquisaProps> = ({}) => {
    return(
        <div>
            <p className="text-sm text-gray-500 mb-2">Busque por uma questão específica.</p>
            <form>   
                <label htmlFor="search" className="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Palavra Chave</label>
