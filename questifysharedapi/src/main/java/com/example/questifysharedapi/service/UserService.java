...
import com.example.questifysharedapi.exception.IncorrectPassword;
import com.example.questifysharedapi.exception.UserNotExist;
...
public class UserService {
    ...
    public AccessToken authenticate(String email, String password) {
        ...
        if(user == null){
            throw new UserNotExist("This email is not registered");
        }
